...
{isEditing ? (
    ...
    <button onClick={handleDoneClick} className='absolute left-[778px] top-[37px] text-dark-green-color font-inherit font-5xl font-semibold leading-[37px]'>Done</button>
     ...
     {/* 2nd */}
       <section >
       <h1 className='absolute left-[18px] top-[97px] text-[26px] font-inherit font-semibold leading-[40px] z-40'>Contact</h1>
...
{/* change pass */}
  ...
  <section className="absolute w-[852px] leading-[48px] h-[72px] left-[515px] top-[803px] border border-strokegreen-color rounded-xl">
      ...
      {/* personal details */}
      {show && (
        <section className="absolute w-[852px] leading-[48px] h-[454px] left-[515px] top-[872px] border border-strokegreen-color rounded-xl">
          {/* 1st */}
          <section>
...
<section className='absolute w-[852px] leading-[48px] h-[72px] left-[515px] top-[917px] border border-strokegreen-color rounded-xl'>
 ...
 <img src={Above} alt="" className='absolute left-[808px] top-[24px]' onClick={onBtnClick2} style={{ transform: `rotate(${rotat}deg)` }} />
 </section>
{/* main section */}
{showDetail && (
