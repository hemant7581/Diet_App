...
import Keto from "../../asset/Keto.png";
...
const Result = () => {
  ...
  return (
    <div className="relative bg-whitesmoke-200 w-full h-[982px] overflow-hidden text-center text-5xl text-black font-sans">
      <div className="absolute top-[0px] left-[0px] bg-whitesmoke-100 w-[1512px] h-[982px]" />
   <img src={logo} className="absolute top-[17px] left-[56px]" alt="" />
      <p
      ...
      <div className="absolute top-[556px] left-[calc(50%_-_332px)] w-[665px] h-[236px] text-left text-[32px]">
        ...
        <div className="absolute top-[196px] left-[calc(50%_-_308.5px)] w-[120px] h-[17px] text-center text-[16px] text-slategray">
          <p
            className="m-0 absolute top-[0px] left-[calc(50%_-_60px)] text-blue font-semibold leading-[156.23%]  inline-block w-[120px] h-[17px]"
            id="starts@599"
          >
            Starts @ 599/-
          </p>
