...
const BmiResult = () => {
  ...
  return (
    <div className="relative bg-whitesmoke w-[1512px] h-[982px] overflow-hidden text-center text-21xl text-text-black-color font-body-main xl:w-full">
      <div className="absolute top-[326px] left-[634px] rounded-xl bg-whitesmoke border b w-[243px] h-[74px]  border-solid border-red-color" />
      <p
        className="m-0 text-29xl font-sans absolute top-[172px] left-[calc(50%_-_60px)] leading-[174.53%] font-semibold fontsans"
        id="Result"
      >
        Result
      </p>
      ...
      <div className="absolute top-[328px] left-[calc(50%_-_75px)] w-[148px] h-[70px] text-dimgray text-center">
        <p
          className="m-0 absolute top-[0px]  text-[40px] left-[calc(50%_-_74px)] leading-[174.53%] font-semibold font-sans text-text-black-color"
          id="bmi_value"
        >{`18.6 `}</p>
        <p
          className="m-0 absolute top-[31px] text-[#504848] left-[85px] text-[18px] leading-[150.19%] font-bold"
          id="bmi_unit"
        >
          kg/m
        </p>
        <p
          className="m-0 absolute top-[27px] text-[#504848] left-[124px] font-body-main text-[16px] leading-[150.19%] font-bold inline-block w-2.5 h-[18px]"
          id="bmi_unit_power"
        >
          2
        </p>
