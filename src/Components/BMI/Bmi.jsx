...
const Bmi = () => {
  ...
  const [sliderPosition, setSliderPosition] = useState({ top: '5%', left: '38.68%'});
  ...
  return (
    <div
      className="relative bg-whitesmoke w-[1512px] h-[982px] ove0rflow-hidden text-center text-13xl text-gray-300 font-sans xl:w-full"
      id="BMI"
    >
      {/* header section */}
      <header
      ...
      <p className="absolute top-[900px] left-[50%] transform [-translate-x-1/2] text-3xl font-semibold">
        {Bmi ? `Your BMI is: ${Bmi}` : ""}
        {/* <BmiResult bmi={Bmi} /> Pass the calculated BMI as a prop */}
      </p>
      {/* result */}
    </div>
  );
