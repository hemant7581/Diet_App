...
const OrderOverview2 = () => {
  ...
  return (
      <div className="absolute w-[1512px] h-[1536px] xl:w-full">
        {/* nav */}
        <Nav />
        {/* nav */}
        ...
        {showDetails && (
          <div>
            <section className=" absolute rounded-full w-[30px] h-[30px] top-[772px] left-[458px] bg-strokegreen-color" />
            <span className="left-[516px] top-[769px] absolute text-2xl font-inherit font-semibold">
              Confirm
            </span>{" "}
            <span className="left-[651px] top-[769px] absolute text-2xl font-inherit font-normal text-grey-color leading-[37px]">
              31 July, 2023
            </span>
            <section className="absolute w-1 h-20 bg-strokegreen-color left-[471px] rounded-xl top-[806px]" />
            {/* 1 */}
            <section className="absolute rounded-full w-[30px] h-[30px] top-[890px] left-[458px] bg-strokegreen-color" />
            <span className="left-[516px] top-[886px] absolute text-2xl font-inherit font-semibold">
              Packed
            </span>{" "}
            <p className="text-2xl absolute left-[651px] top-[883px] font-inherit font-normal text-grey-color leading-[37px] ">
              01 Aug, 2023
            </p>
            <section className="absolute w-1 h-20 border outline-1 outline-black  rounded-xl left-[471px] top-[924px]" />
            {/* 2 */}
            <section className="absolute rounded-full w-[30px] h-[30px] top-[1011px] left-[458px] border outline-1 outline-black " />
            <span className="left-[516px] top-[1010px] absolute text-2xl font-inherit font-semibold">
              Shipped
            </span>{" "}
            <span className="text-2xl absolute left-[651px] top-[1008px] font-inherit font-normal text-grey-color leading-[37px] ">
              02 Aug, 2023
            </span>
            <section className="absolute w-1 h-20 border outline-1 outline-black  rounded-xl left-[471px] top-[1045px]" />
            {/* 3 */}
            <section className="absolute rounded-full w-[30px] h-[30px] top-[1132px] left-[458px] border outline-1 outline-black " />
            <span className="left-[516px] top-[1130px] absolute text-2xl font-inherit font-semibold">
              Out of Delivery
            </span>{" "}
            <span className="text-2xl font-inherit absolute left-[713px] top-[1129px] font-normal text-grey-color leading-[37px] ">
              05 Aug, 2023
            </span>
            <section className="absolute w-1 h-20 border outline-1 outline-black  rounded-xl left-[471px] top-[1166px]" />
            {/* 4 */}
            <section className="absolute rounded-full w-[30px] h-[30px] top-[1253px] left-[458px] border outline-2 outline-black " />
            <span className="left-[516px] top-[1251px] absolute text-2xl font-inherit font-semibold">
              Delivered Successfully
            </span>{" "}
            <span className="text-2xl font-inherit font-normal absolute left-[785px] top-[1250px] text-grey-color leading-[37px] ">
              05 Aug, 2023
            </span>
            {/* 5 */}
          </div>
        ...
        {/* Conditionally render the details based on showDetails */}
        <button className="absolute inline-flex items-center left-[921px] top-[1415px] font-inherit text-dark-green-color text-2xl font-semibold [background:linear-gradient(93.37deg,_rgba(175,_228,_126,_0.4),_rgba(216,_250,_185,_0.4))] py-[28px] px-[73px] rounded-2xl h-[29px] border border-solid border-[#CFF7AA]">
          Track
        </button>
        </section>
        {/* main */}
