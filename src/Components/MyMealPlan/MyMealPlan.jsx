...
<section className="absolute w-[962px] h-[318px] left-[458px] top-[317px] border bprder-solid border-stroke-greencolor rounded-[12px] shadow-xl bg-whitesmoke">
...
{/* input field */}
<input type ="radio" id="activate" className="absolute cursor-pointer  left-[244px] top-[253px] w-[22px] h-[22px] accent-dark-green-color "   checked={isChecked} required={true}  onClick={() => setIsChecked(!isChecked)}/> <span id="activate" className=" cursor-pointer text-5xl text-normal font-inherit leading-9 absolute left-[279px] top-[245px] text-black">Activated</span>
{/* input field */}
</section>
